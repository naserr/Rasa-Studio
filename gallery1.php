...
<body>
	<div class="container">
		...
		<div class="contain">
			...
			<div class="gallery">
				<img class="center" src="images/f1.jpg" width="598" height="380" />
				<div class="naviga">
					<a href="gallery1.php"><img class="navigaa" src="images/perivios.gif" width="50" height="50" /></a>
					<a href="gallery2.php"><img class="navigab" src="images/next.gif" width="50" height="50" /></a>
