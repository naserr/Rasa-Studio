...
<br />
	...
	<div class="clear"></div>
		<div class="contain">
			...
			<img class="top" src="images/Headset2.gif" width="200" height="200" />

            <ul class="muz">
				<li><a href="music/numb.mp3"><img class="hd" alt="" title="Play Or Download" src="images/playit.gif" width="50" height="50" /></a></li>
				<li><a href="#"><img class="hd" src="images/puse.gif" width="50" height="50" /></a></li>

				<li><a href="#"><img class="hd" src="images/stop.gif" width="50" height="50" /></a></li>
				<li><a href="work1.php"><img class="hd" title="previous Work" src="images/perivios.gif" width="50" height="50" /></a></li>

				<li><a href="work3.php"><img class="hd" title="Next Work" src="images/next.gif" width="50" height="50" /></a></li>
...
<embed height="0px" width="0px" src="numb.mp3" /> <p class="player">
برای نمایش پلیر لطفا مرورگر خود را به IE9 بروز رسانی کنید! </p>
            ...
            <p class="z">نام اثر :<br />Numb By Piano<br />نام آلبوم : اولین آلبوم<br />تاریخ اثر : 10/20/2011</p>
            </div>
			<div class="clear"></div>
		</div>
