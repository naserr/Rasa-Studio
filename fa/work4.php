...
<br />
	...
	<div class="clear"></div>
		<div class="contain">
            ...
            <ul class="muz">
				<li><a href="music/in.mp3"><img class="hd" title="Play Or Download" src="images/playit.gif" width="50" height="50" /></a>
                </li>
				...
				<li><a href="work3.php"><img class="hd" title="previous Work" src="images/perivios.gif" width="50" height="50" /></a>
                </li>

				<li><a href="work5.php"><img class="hd" title="Next Work" src="images/next.gif" width="50" height="50" /></a>
                </li>
...
<embed height="0px" width="0px" src="in.mp3" /> <p class="player">
برای نمایش پلیر لطفا مرورگر خود را به IE9 بروز رسانی کنید! </p>
            ...
            <p class="z">نام اثر :<br />In_Pieces By Piano<br />نام آلبوم : اولین آلبوم<br />تاریخ اثر : 10/20/2011</p>
            </div>
			<div class="clear"></div>
		</div>
