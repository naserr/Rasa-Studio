...
<body>
	<div class="container">
		...
		<div class="contain">
			...
			<div class="gallery">
				<img class="center" src="images/f5.jpg" width="598" height="380" />
				<div class="naviga">
					<a href="gallery4.php"><img class="navigaa" src="images/perivios.gif" width="50" height="50" /></a>
					<a href="gallery6.php"><img class="navigab" src="images/next.gif" width="50" height="50" /></a>
